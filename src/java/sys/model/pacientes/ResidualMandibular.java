...
@Entity
@Table(name = "residual_mandibular")
public class ResidualMandibular  implements java.io.Serializable {
    ...
    public ResidualMandibular() {
    }

	
    public ResidualMandibular(String u, String v, String afilado) {
        this.u = u;
        this.v = v;
        this.afilado = afilado;
    }
    /*
    public ResidualMandibular(String u, String v, String afilado, Set formaResiduals) {
       this.u = u;
       this.v = v;
       this.afilado = afilado;
