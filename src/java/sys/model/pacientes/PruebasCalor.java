...
public class PruebasCalor  implements java.io.Serializable {
    ...
    public PruebasCalor(String organo, String normal, String fugaz, String ninguno, String persistente, String incremento, String irradiado, String drecremento) {
        this.organo = organo;
        this.normal = normal;
        this.fugaz = fugaz;
    ...
    /*
    public PruebasCalor(String organo, String normal, String fugaz, String ninguno, String persistente, String incremento, String irradiado, String drecremento, Set pruebasTermicases) {
       this.organo = organo;
       this.normal = normal;
       this.fugaz = fugaz;
       this.ninguno = ninguno;
